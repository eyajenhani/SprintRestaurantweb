...
/* restaurantrestaurantBundle:RechercherRestaurant:salon_de_the.html.twig */
class __TwigTemplate_3535c0c00f6f12e0f4e273e292e68306af36bf39f8581a67030826ce0867119d extends Twig_Template
{
...
\t\t\t\t\t\t<a href=\"blog-post.html\"><img src=\"images/demo/photodune-471512-wine-cheese-garden-party-l-1140x435.jpg\" class=\"aligncenter\" alt=\"blog-image\"></a>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"blog-post-background\">
\t\t\t\t\t\t<h2 class=\"post-title\"><a href=\"blog-post.html\">Salon de thé  1 </a></h2>
\t\t\t\t\t\t
\t\t\t\t\t\t<div class=\"blog-post-excerpt\">
\t\t\t\t\t\t    \t<h6 >Description:</h6>
\t\t\t\t\t\t\t<p> Quisque velit velit, imperdiet convallis blandit quis, molestie et eros. Duis ac pharetra orci. Phasellus vitae purus nibh. Sed tincidunt ante dignissim lorem molestie a tempor turpis tempor. Sed adipiscing venenatis massa, ut pulvinar turpis malesuada et.</p>
\t\t\t\t\t\t\t<h6>Budget moyenne:</h6>
\t\t\t\t\t\t\t20DT
\t\t\t\t\t\t\t\t<h6>Adresse :</h6>
\t\t\t\t\t\t</div>
\t\t\t\t<a href=\"menu.html\" class=\"rock-button\">Consulter menu</a> 
\t\t\t\t\t\t<a href=\"reservation.html\" class=\"rock-button\">Réserver</a>
...
\t\t\t\t<div class=\"type-post\">
\t\t\t\t\t<div class=\"blog-post-image\">
\t\t\t\t\t\t<a href=\"blog-post.html\"><img src=\"images/demo/photodune-792391-close-up-of-business-hand-hold-touch-screen-mobile-phone-and-buttons-m-1140x435.jpg\" class=\"aligncenter\" alt=\"blog-image\"></a>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"blog-post-background\">
\t\t\t\t\t\t<h2 class=\"post-title\"><a href=\"blog-post.html\">Salon de thé 2</a></h2>
\t\t\t\t\t\t<div class=\"blog-post-excerpt\">
\t\t\t\t\t\t\t\t<h6 >Description:</h6>
\t\t\t\t\t\t\t<p> Quisque velit velit, imperdiet convallis blandit quis, molestie et eros. Duis ac pharetra orci. Phasellus vitae purus nibh. Sed tincidunt ante dignissim lorem molestie a tempor turpis tempor. Sed adipiscing venenatis massa, ut pulvinar turpis malesuada et.</p>
\t\t\t\t\t\t\t<h6>Budget moyenne:</h6>
...
\t\t\t\t</div><!-- close .type-post -->
\t\t\t\t
\t\t\t\t<div class='pagination'><a href='#' class='selected'>1</a><a href='#' class='inactive' >2</a></div>
\t\t\t\t
\t\t\t\t
\t\t\t
\t\t\t<div class=\"clearfix\"></div>
...
\t</div><!-- close #main -->
    ...
    {
        return "restaurantrestaurantBundle:RechercherRestaurant:salon_de_the.html.twig";
    }
